...
@register_function(
    ...
    inputs=[
        ...
        {"name": "rls_code",   "type": "str"},
        {"name": "lst_rls",    "type": "str", "options": ["Y", "N"]},
        {"name": "pnd_rsn",    "type": "str"},
        {"name": "pnd_op_id",  "type": "str"},
        {"name": "flw_up",     "type": "str"},
        {"name": "dist_unit",  "type": "str"},
        {"name": "eob",        "type": "str"},
        {"name": "ck",         "type": "str"},
        {"name": "note",       "type": "str"},
        {"name": "payee",      "type": "str", "options": ["0", "1", "2", "3"]},
        {"name": "eob_note",   "type": "str"},
        {"name": "verify",     "type": "str", "options": ["Y", "N"]},
        # --- OI / UC ---
        {"name": "apply_uc",         "type": "str", "options": ["Y", "N"]},
        {"name": "rem_oi_elig_amt",  "type": "str", "options": ["Y", "N"]},
        {"name": "apply_001",        "type": "str", "options": ["N/A", "1 ONLY", "ALL LINES"]},
        {"name": "deny_clm",         "type": "str", "options": ["Y", "N"]},
        {"name": "add_time",         "type": "str", "options": ["Y", "N"]},
        # --- inel amt/cd ---
        {"name": "vld_amt_pd",             "type": "str", "options": ["Y", "N"]},
        {"name": "vld_amt_pd_by_cpt",      "type": "str", "options": ["Y", "N"]},
        {"name": "remove_prv",             "type": "str", "options": ["Y", "N"]},
        {"name": "remove_inel_amt_cd",     "type": "str", "options": ["N/A", "INEL/CD1", "INEL/CD2", "INEL/CD ALL", "SPECIFIC"]},
        {"name": "denial_code",            "type": "str"},
        {"name": "aply_inel_cd_spcfc_rmval", "type": "str", "options": ["Y", "N"]},
        {"name": "inel_cd_to_rmv",         "type": "str"},
        # --- DX / Lab / Rev ---
        {"name": "apply_dx",       "type": "str", "options": ["Y", "N"]},
        {"name": "apply_lab",      "type": "str", "options": ["Y", "N"]},
        {"name": "dx_lab_rev",     "type": "str", "options": ["Y", "N"]},
        {"name": "apply_bn_t_hold","type": "str", "options": ["Y", "N"]},
        # --- BN / Modifier ---
        {"name": "apply_bn_qty",   "type": "str", "options": ["Y", "N"]},
        {"name": "chnge_dx_cd",    "type": "str", "options": ["Y", "N"]},
        {"name": "new_oi_elig_pd", "type": "str", "options": ["N/A", "Y", "N"]},
        {"name": "new_oi_indctr",  "type": "str", "options": ["N/A", "Y", "N"]},
        {"name": "inel_switch",    "type": "str", "options": ["Y", "N"]},
        # --- DX exception / Condition / Grid ---
        {"name": "aply_dx_excptn", "type": "str", "options": ["Y", "N"]},
        {"name": "aply_cond_nt",   "type": "str", "options": ["Y", "N"]},
        {"name": "aply_grid_prc",  "type": "str", "options": ["Y", "N"]},
        {"name": "updt_frm_to_dt", "type": "str", "options": ["Y", "N"]},
        {"name": "aply_tod_updt",  "type": "str", "options": ["Y", "N"]},
        # --- AP code / Int-Zip / Cond-AFV ---
        {"name": "remove_ap",      "type": "str", "options": ["Y", "N"]},
        {"name": "aply_int_zip",   "type": "str", "options": ["Y", "N"]},
        {"name": "aply_cond_afv",  "type": "str", "options": ["Y", "N"]},
        {"name": "aply_850_nt",    "type": "str", "options": ["DO NOT APPLY NOTE", "APPEND ON CURRENT NOTE", "2ND LINE ONLY"]},
        {"name": "rem_code_set",   "type": "str", "options": ["Y", "N"]},
        # --- Modifier / Provider ---
        {"name": "aply_modifr",    "type": "str", "options": ["Y", "N"]},
        {"name": "inel_code",      "type": "str"},
        {"name": "remv_prov_rate", "type": "str", "options": ["Y", "N"]},
        {"name": "remv_modifr",    "type": "str", "options": ["Y", "N"]},
        {"name": "aply_two_ap_cd", "type": "str", "options": ["Y", "N"]},
        # --- Bypass / 858 / Bond / HIC ---
        {"name": "remv_prcrt_byps","type": "str", "options": ["Y", "N"]},
        {"name": "amt_858_inq",    "type": "str", "options": ["Y", "N"]},
        {"name": "bond_clinic",    "type": "str", "options": ["Y", "N"]},
        {"name": "updt_oc_for_700","type": "str", "options": ["Y", "N"]},
        {"name": "updt_hic",       "type": "str", "options": ["Y", "N"]},
        # --- Adj / 631 / State-Type ---
        {"name": "remv_adj_cd",    "type": "str", "options": ["Y", "N"]},
        {"name": "aply_631_inel",  "type": "str", "options": ["Y", "N"]},
        {"name": "aply_st_typ",    "type": "str", "options": ["N/A", "Y", "N"]},
        {"name": "aply_dpsv",      "type": "str", "options": ["Y", "N"]},
        {"name": "chk_inel",       "type": "str", "options": ["Y", "N"]},
        # --- Per-diem / Discount-after-denial ---
        {"name": "chk_per_diem",   "type": "str", "options": ["Y", "N"]},
        {"name": "dis_aft_dnl",    "type": "str", "options": ["Y", "N"]},
        {"name": "seq_ordr",       "type": "str", "options": ["Y", "N"]},
        {"name": "rem_iu",         "type": "str", "options": ["Y", "N"]},
        {"name": "rem_tu",         "type": "str", "options": ["Y", "N"]},
        # --- OPI / BN delete / Medicare denial ---
        {"name": "aply_opi",          "type": "str", "options": ["N", "Y", "D"]},
        {"name": "del_bn",            "type": "str", "options": ["Y", "N"]},
        {"name": "aply_dnl_aft_medcr","type": "str", "options": ["Y", "N"]},
        # --- Flip-mod / Disc-after-flip ---
        {"name": "flip_mod",           "type": "str", "options": ["Y", "N"]},
        {"name": "apply_disc_aft_flip","type": "str", "options": ["Y", "N"]},
        {"name": "rem_disc_amt_flag",  "type": "str", "options": ["N", "Y", "Y-DONT READ OITYPE"]},
        # --- FAIE / 034 / S9451 / HCR ---
        {"name": "faie_adj_inel",  "type": "str", "options": ["Y", "N"]},
        {"name": "aply_034_inel",  "type": "str", "options": ["Y", "N"]},
        {"name": "dny_s9451",      "type": "str", "options": ["Y", "N"]},
        {"name": "id_hcr",         "type": "str", "options": ["Y", "N"]},
        {"name": "2nd_inel_001",   "type": "str", "options": ["Y", "N"]},
    ],
    outputs=[
